...
const personalDetails = [
  ...
  {
    label: "Email:",
    value: "ajaykumarshetty539@gmail.com",
  },
  {
    label: "Contact No:",
    value: "+91 9573087605",
...
const jobSummary =
  ...
  "I am a passionate front-end developer skilled in HTML, CSS, JavaScript, and React. I have a strong background in Python programming and data structures. I am proficient in designing and managing relational databases with SQL and experienced in using MongoDB for scalable NoSQL solutions. Additionally, I have a basic understanding of Node.js and Express.js. My expertise lies in building dynamic, responsive web applications with a focus on user experience. I am always eager to learn new technologies and take on challenging projects. Let's connect and create something amazing together!";
const About = () => {
  return (
